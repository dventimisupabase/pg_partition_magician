...
select pgpm.transmute('public.events_id', 'id', 10000, p_obtain => 2, p_drain_batch => 5000);
...
select pgpm.transmute('public.events_uuid', 'id', interval '1 month', p_obtain => 2, p_drain_batch => 5000);
