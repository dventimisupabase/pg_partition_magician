...
-- ---- fixture: a table with many closed STRAY intervals for the drain to work -------------
...
-- daily interval the drain evacuates, one per maintenance tick, giving the controller plenty
...
call pgpm.transmute('public.evt', 'created_at', interval '1 day', p_obtain => 2, p_drain_batch => 8000, p_paused => false);
