...
call pgpm.transmute('public.ar', 'id', 50, p_regrain_batch => 30, p_paused => false);   -- monolith [0, 250) -- 5 steps; batch 30
select pgpm.obtain('public.ar');
insert into public.ar (id, payload) values (1000, 'frontier');   -- advance frontier past B=250 -> monolith frozen
