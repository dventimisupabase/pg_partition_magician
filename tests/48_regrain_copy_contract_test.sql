...
call pgpm.transmute('public.cc', 'id', 50, p_regrain_batch => 20, p_paused => false);  -- monolith [0,B); batch 20
select pgpm.obtain('public.cc');
insert into public.cc (id, payload) values (1000, 'frontier');   -- advance frontier past B -> monolith frozen
